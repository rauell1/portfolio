...
const SOCIAL_LINKS = [
  { href: "https://www.linkedin.com/in/roy-otieno-60b190174/", label: "LinkedIn",    Icon: LinkedInIcon },
  { href: "https://github.com/rauell1",                        label: "GitHub",      Icon: GitHubIcon   },
  { href: "https://x.com/rauell_",                             label: "X (Twitter)", Icon: XIcon        },
  { href: "https://wa.me/254726683835",                        label: "WhatsApp",    Icon: WhatsAppIcon },
];
  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.div
          {...fadeUp}
          transition={{ ...fadeUp.transition, delay: prefersReducedMotion ? 0 : 0.5 }}
        ...
        >
          {SOCIAL_LINKS.map(({ href, label, Icon }) => (
            <a
              ...
              aria-label={label}
              title={label}
              className="p-2.5 rounded-xl bg-muted/50 border border-border/60 hover:bg-primary/10 hover:border-primary/40 hover:text-primary text-muted-foreground transition-all duration-200"
            >
        ...
        >
          ...
          <a
            href="#contact"
            onClick={(e) => { e.preventDefault(); const el = document.querySelector("#contact"); if (el) smoothScrollTo(el); }}
          ...
          <a
            ...
            download
            className="flex items-center gap-2 px-8 py-4 font-semibold rounded-xl border border-border hover:border-primary/50 hover:bg-primary/5 transition-all duration-300"
          >
